  ...
  return (
    <section className="mt-16 w-full max-w-xl">
      ...
      <div className="flex flex-col w-full gap-2">
        ...
        <form className="relative flex justify-center items-center" onSubmit={handleClick}>
            ...
            article.summary && (
              <div className="flex flex-col gap-3">
                ...
                <div className="summary_box relative">
                  <div className="copy_btn absolute top-1 right-1 h-16 w-16 " onClick={() => handleCopyArticle(article.summary)}>
                    <img src={copyArticle === article.summary ? tick : copy} alt="copy_icon" className="w-[50%] h-[50%] object-contain" />
                  </div>
                  <p className="font-inter font-medium text-base mt-2 text-gray-700">{article.summary}</p>
                </div>
              </div>
            ))}
        </div>
